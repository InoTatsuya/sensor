...
#	printTime("soil1:")
	...
	li = getData(start_day, end_day, ID_SOIL)
...
def update_live_graph_temp(n):
	...
	end_day = datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
	start_day = (datetime.datetime.now() - datetime.timedelta(days=7)).strftime("%Y-%m-%d %H:%M:%S")
	li = getData(start_day, end_day, ID_TEMP)
...
#	printTime("lux:1")
	...
	end_day = datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
	start_day = (datetime.datetime.now() - datetime.timedelta(days=7)).strftime("%Y-%m-%d %H:%M:%S")
	li = getData(start_day, end_day, ID_LUX)
...
if __name__ == "__main__":
	app.run_server(debug=True, host="172.31.36.179", port="8060")
